...
# python train.py --cfg configs/baseline_unet.py -acq both -l log/baseline_unet_20 --sample_num 20
# CUDA_VISIBLE_DEVICES=2,3 python train.py --cfg configs/complex_unet.py -acq both -l log/complex_unet/ --sample_num 20